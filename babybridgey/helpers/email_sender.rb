...
module Sinatra
  module EmailSender
         ...
         "content": [
           {
             ...
             '<p> If you have any further questions, concerns or other feedback, do not hesitate to contact us at ' + p['thisUser'] + ' and we will reply as soon as possible.</p></html>"
           }
         ],
         "from": {
         ...
         "personalizations": [
           {
             ...
             "cc": [
               {
                 "email": "' + params['thisUser'] + '",
                 "name": "' + full_name(params['thisUser']) + '"
               }
             ],
             "to": [
               {
               ...
               {
                 "email": "ryan@charltonhoward.co.uk",
                 "name": "Ryan Howard"
               }
             ]
           }
    ...
    def full_name(user)
      extractuser = user.split('@')[0]
      name = extract_name(extractuser)
      name[0] + " " + name[1]
    end
